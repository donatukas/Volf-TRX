...
module  TX_CLK_CTRL_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //TX_CLK_CTRL_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  TX_CLK_CTRL_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    outclk);
...
`endif
    ...
    TX_CLK_CTRL_altclkctrl_0_sub  TX_CLK_CTRL_altclkctrl_0_sub_component (
                .clkselect (sub_wire2),
                .ena (sub_wire4),
                .inclk (sub_wire6),
                .outclk (sub_wire0));
